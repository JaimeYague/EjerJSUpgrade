...
const rolePlaying = videogames.filter( game => game.genders.includes('RPG'));

console.log(rolePlaying);

const totalScore = rolePlaying.reduce((suma, game) => suma + game.score, 0);
const media = totalScore / rolePlaying.length;
